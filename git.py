...
url_remote = 'http://git.spymovil.com/ycabrera/automatismos.git'
...
staged_files = [
                    ...
                    'CTRL_FREC/ctrl_config.ini',
                    'CTRL_FREC/error_process_DLGID.py',
                    'CTRL_FREC/ctrl_process_frec_DLGID.py',
                    'CTRL_FREC/PROCESS/ctrl_error.py',
                    'CTRL_FREC/PROCESS/ctrl_library.py',
                    'CTRL_FREC/PROCESS/ctrl_process.py',
                    'CTRL_FREC/PROCESS/drv_visual.py',
                    # 
                    # ROOT
                    'drv_logs.py',
                    'drv_config.py',
                    ...
                    'drv_db_GDA.py',
                    'git.py',
                    'serv_APP_selection.py',
                    'drv_dlg.py',
                    'mypython.py',
                    'serv_error_APP_selection.py',
                    'README',
                ]
